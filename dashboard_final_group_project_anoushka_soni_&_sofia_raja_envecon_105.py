...
This case study examines the link between CO₂ emissions and temperature trends at global, national, and country-comparison levels. Globally, emissions have risen sharply, accelerating after the mid-20th century. A comparison of the top 10 emitting countries in 2014 shows China, the U.S., and India as leading contributors, with emerging economies rapidly increasing their output and some developed nations showing slower growth or decline. In China, temperatures continue to rise, indicating lagged climate effects and the influence of global emissions. A correlation analysis between China's emissions and temperatures from 1980–2014 reveals a modest positive relationship, supporting the broader evidence that greenhouse gas emissions contribute to warming trends.

We've included our findings and analysis throught this notebook for each of the figures created, however, here is an analysis of the summary of all the graphs:
